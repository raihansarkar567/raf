@extends('layouts.auth_admin_layout')
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="business_id" type="text" class="form-control @error('number') is-invalid @enderror" name="business_id" value="{{Auth::user()->id}}" required autocomplete="business_name" autofocus readonly>
