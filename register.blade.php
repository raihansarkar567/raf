            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- {{-- more Business Info Start --}} -->
                        <div class="form-group row">
                            <label for="business_name" class="col-md-4 col-form-label text-md-right">{{ __('Business Name') }}</label>

                            <div class="col-md-6">
                                <input id="business_name" type="text" class="form-control @error('name') is-invalid @enderror" name="business_name" value="{{ old('business_name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="catagories" class="form-control selectpicker">
                                        <option value="{{ old('catagories') }}" class="form-control @error('name') is-invalid @enderror"autofocus>Select your Catagory</option>
                                        <option>Food</option>
